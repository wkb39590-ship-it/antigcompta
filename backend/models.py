...
#     # ✅ NOT NULL en DB
#     operation_confidence = Column(Float, nullable=False)
...
#     # ✅ (optionnel) relation vers Societe si tu l’as déjà dans models
#     societe = relationship("Societe", back_populates="factures", lazy="joined")
...
#     # FK vers societes.id (comme en DB)
#     societe_id = Column(Integer, ForeignKey("societes.id"), nullable=False, index=True)

#     # NOT NULL en DB
#     operation_type = Column(String(50), nullable=False)          # "achat" / "vente"
#     operation_confidence = Column(Float, nullable=False)         # ex: 0.95
