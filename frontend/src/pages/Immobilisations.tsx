    ...
    return (
        <div style={{ padding: '32px', maxWidth: '1300px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '32px' }}>
                <div>
                    <h1 style={{ fontSize: '28px', fontWeight: 700, color: 'var(--text)', margin: 0 }}>🏗️ Immobilisations</h1>
                    <p style={{ color: 'var(--text2)', margin: '4px 0 0' }}>Gestion des actifs et plans d'amortissement</p>
                </div>
