...
import Upload from './pages/agent/Upload'
import FactureDetail from './pages/agent/FactureDetail'
import PcmPage from './pages/agent/PcmPage'
import Profile from './pages/agent/Profile'
import History from './pages/agent/History'
import SupplierDirectory from './pages/agent/SupplierDirectory'
import Login from './pages/Login'
import ClientPortal from './pages/client/ClientPortal'
import Avoirs from './pages/agent/Avoirs'
import AvoirDetailView from './pages/agent/AvoirDetail'
import Immobilisations from './pages/agent/Immobilisations'
import ImmoDetail from './pages/agent/ImmoDetail'
import TransmissionDashboard from './pages/agent/TransmissionDashboard'
import JournalComptable from './pages/agent/JournalComptable'
